  ...
  render() {
    ...
    return (
      <div id="Footer" className="flex flex-row-l flex-column items-center justify-between-l tc pa4 bt b--black-05">
        <h1 className="flex f4 ttu fw9 tracked mv0-ns mb3">The Rate of Change</h1>
        ...
        <small className="flex f7 mv0-l mv4 black-20">© 2017<b className="pl1">Dennis Cortés</b></small>
