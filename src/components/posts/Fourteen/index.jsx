    ...
    return (
      <div className="cf w-100">
        ...
        <div id="14" className="bg-white br3 ph5-l pv4-l ph4 pv3 shadow-custom">
          ...
          <ol className="lh-copy black-60 f4">
            <li className="mb4"><strong>Take more walks.</strong> Walk to work instead of driving. If that’s not possible, take a quick walk before your drive. Or even better, work out before or after work, even if it’s just 15 minutes a day.</li>
            <li className="mb4"><strong>Work from somewhere different.</strong> Change up your environment or even just the layout of your desk and what you have on it. And make sure you are comfortable with your layout. Keeping a clean desk area is very important, only have what you absolutely need and use on there.</li>
            <li className="mb4"><strong>Diversify your inspiration.</strong> Instead of looking at the newest inspiration on Dribbble, search for older resources. There is a TON of inspiration for layouts, letters, brands, etc. from older graphic design work and articles.</li>
            <li className="mb4"><strong>Talk to more people.</strong> Instead of browsing the news while your waiting for your morning coffee, strike up a conversation with the barista, a coworker, or a random person in line. Learning from different perspectives is a sure way to provide different ideas stirring in your mind.</li>
            <li className="mb4"><strong>Start a new hobby.</strong> For example, I’ve started cooking a lot more at home. Working with my hands and having some time away from technology gives me time to think and let ideas stir. Try that new thing you’ve been wanting to try.</li>
            <li className="mb4"><strong>Try new food and drinks.</strong> Everyone loves food. A nice way to change what your used to is by trying a new restaurant or coffee shop. And if you aren’t in the position to eat out, cooking new food from home is a good option. You can mix this with #5 if you’d like.</li>
            <li className="mb4"><strong>Work in analog more.</strong> Sketch/write your ideas on a nice new notebook instead of relying on technology. There’s something about pencil to paper that’s really satisfying and inspiring for ideas.</li>
            <li className="mb4"><strong>Don’t rely on digital.</strong> To go with #6, don’t rely on finding ideas and inspiration in the digital space. Books and magazines are awesome places for inspiration. Some of my favorites include <L hrefLink="http://amzn.to/2gpaL00">Designing Brand Identity</L> and <L hrefLink="http://amzn.to/2hiHmSa">Grid Systems in Graphic Design</L> for books. WIRED, The Great Discontent, and KINFOLK are some of my favorite magazines for design inspiration.</li>
            <li className="mb4"><strong>Take breaks.</strong> Getting in your head too much is never healthy. If you feel frustrated with creative block, step away for a bit. When you come back you’ll have a fresh perspective to work with. Whether it be 5 minutes or a few days, take the time you need to reset.</li>
          </ol>
